...
class avartarCard extends VirtualNode {
    constructor(emoji) {
        super({
            ...
            attrs: {
                class: "avatar-card",
                style: "width: 100px; height: 100px; border-radius: 50%; margin: 7px;  background-color: #f1f1f1; display: flex; justify-content: center; align-items: center; font-size: 4rem; color: #000; font-weight: bold;"
            },
            children: [emoji],
        })
    }
